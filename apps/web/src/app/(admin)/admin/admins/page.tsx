...
export default function AdminAdminsPage() {
  ...
  function reload() {
    apiClient.get<AdminUser[]>('/admin/admins').then(setAdmins).catch(() => setAdmins([]));
  }
  ...
  return (
    <div>
      ...
      <div className="mt-4 rounded-card-lg border border-card-border bg-white p-5 shadow-card">
        <h2 className="mb-3 font-semibold text-ink-strong">{t.rolesTitle}</h2>
